...
.. raw:: html
 ...
 <pre class="line-numbers pre-replacer" data-start="1"><code id="qt_framework_rst-host-41" class="language-markup">wget http://download.qt-project.org/official_releases/qt/4.8/4.8.6/qt-everywhere-opensource-src-4.8.6.zip
...
The installation of the libraries for Pengwyn from sources is sligthly more complicated. Once you downloaded
...
.. raw:: html
 ...
 <pre class="line-numbers pre-replacer" data-start="1"><code id="qt_framework_rst-host-42" class="language-markup">wget http://download.qt-project.org/official_releases/qt/4.8/4.8.6/qt-everywhere-opensource-src-4.8.6.zip
 unzip qt-everywhere-opensource-src-4.8.6.zip
 cd qt-everywhere-opensource-src-4.8.6
 cp -r mkspecs/qws/linux-arm-g++/ mkspecs/qws/linux-pengwyn-g++
 cd mkspecs/qws/linux-pengwyn-g++/
...
.. raw:: html
 ...
 <pre class="line-numbers pre-replacer" data-start="1"><code id="qt_framework_rst-host-43" class="language-markup">#
 ...
 QMAKE_CC                = arm-poky-linux-gnueabi-gcc --sysroot=/home/architech/architech_sdk/architech/pengwyn/toolchain/sysroots/armv7a-vfp-neon-poky-linux-gnueabi
 QMAKE_CXX               = arm-poky-linux-gnueabi-g++ --sysroot=/home/architech/architech_sdk/architech/pengwyn/toolchain/sysroots/armv7a-vfp-neon-poky-linux-gnueabi
 QMAKE_LINK              = arm-poky-linux-gnueabi-g++ --sysroot=/home/architech/architech_sdk/architech/pengwyn/toolchain/sysroots/armv7a-vfp-neon-poky-linux-gnueabi
 QMAKE_LINK_SHLIB        = arm-poky-linux-gnueabi-g++ --sysroot=/home/architech/architech_sdk/architech/pengwyn/toolchain/sysroots/armv7a-vfp-neon-poky-linux-gnueabi
...
.. raw:: html
 ...
 <pre class="line-numbers pre-replacer" data-start="1"><code id="qt_framework_rst-host-44" class="language-markup">cd ../../../
 ./configure -no-pch -opensource -confirm-license -prefix /usr/local/Trolltech/Pengwyn -no-qt3support -embedded arm -nomake examples -nomake demo -little-endian -xplatform qws/linux-pengwyn-g++ -qtlibinfix E
 make
 make install</code></pre>
 <script src="_static/prism.js"></script>
 <script src="_static/select_text.js"></script>
