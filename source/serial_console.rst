...
.. raw:: html
 ...
 <pre class="line-numbers pre-replacer" data-start="1"><code id="serial_console_rst-host-213" class="language-markup">[ 2614.290675] usb 3-4: &gt;new full-speed USB device number 4 using xhci_hcd
