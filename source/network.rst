...
.. raw:: html
 ...
 <div>
 <div><b class="admonition-board">&nbsp;&nbsp;Board&nbsp;&nbsp;</b>&nbsp;&nbsp;<a style="float: right;" href="javascript:select_text( 'network_rst-board-241' );">select</a></div>
 <pre class="line-numbers pre-replacer" data-start="1"><code id="network_rst-board-241" class="language-markup">root@pengwyn:~# ifconfig
...
.. raw:: html
 ...
 <div>
 <div><b class="admonition-board">&nbsp;&nbsp;Board&nbsp;&nbsp;</b>&nbsp;&nbsp;<a style="float: right;" href="javascript:select_text( 'network_rst-board-242' );">select</a></div>
 <pre class="line-numbers pre-replacer" data-start="1"><code id="network_rst-board-242" class="language-markup">auto eth0
